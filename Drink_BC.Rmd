---
title: "behavior and  Breast Cancer Pleiotropy analysis"
...
```{r}
Drink_BC<-read.csv("Data/Drink_BC.csv")
```

There are 78 snps in both exposure and outcome dataset. 
